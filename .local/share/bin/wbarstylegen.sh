...
export b_radius=$(( b_height ))   # block rad 70% of height (type1)
export c_radius=$(( b_height ))   # block rad 25% of height {type2}
export t_radius=$(( b_height ))   # tooltip rad 25% of height
export e_margin=$(( b_height*13/100 ))   # block margin 30% of height
export e_paddin=$(( b_height*10/100 ))   # block padding 10% of height
export g_margin=$(( b_height*13/100 ))   # module margin 14% of height
export g_paddin=$(( b_height*15/100 ))   # module padding 15% of height
export w_radius=$(( b_height ))   # workspace rad 30% of height
export w_margin=$(( b_height*10/100 ))   # workspace margin 10% of height
export w_paddin=$(( b_height*1/100 ))   # workspace padding 10% of height
